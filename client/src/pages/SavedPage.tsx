...
export default function SavedPage() {
  ...
  const saved = useMemo(
    () => (products.data ?? []).filter(product => savedHandles.has(product.handle)),
    [products.data, savedHandles]
  );
