  ...
  return (
    <article className={`product-card group ${featured ? "featured" : ""}`}>
      <Link href={`/product/${product.handle}`} className="product-image-wrap">
        {product.images[0] ? <img src={product.images[0].url} alt={product.images[0].altText ?? product.title} className="product-image" /> : <div className="image-placeholder"><Leaf size={30} /></div>}
    ...
    <section className="hero-section" style={{ backgroundImage: `url(${HERO_ART})` }}>
      ...
      <div className="mx-auto grid min-h-[calc(100vh-110px)] max-w-[1360px] items-center px-5 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
        <div className="hero-copy">
          <p className="eyebrow text-amber-200"><span className="eyebrow-rule" /> Trusted suppliers. Premium quality.</p>
          ...
          <p className="mt-7 max-w-[440px] text-base leading-7 text-white/65 sm:text-lg">Access a curated marketplace of organic, sustainable products from verified suppliers worldwide.</p>
